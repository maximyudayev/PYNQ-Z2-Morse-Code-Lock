...
HD_PWD='/home/maxim/Vivado/Lab4/MORSE_CODE/MORSE_CODE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_code_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source morse_code_lock.tcl
